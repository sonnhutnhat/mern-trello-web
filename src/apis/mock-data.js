  ...
  board: {
    ...
    columns: [
      ...
      },
      {
         ...
         *** Kỹ hơn nữa về cách tạp chuẩn ở bước nào thì sẽ học phần tích hợp API Back-end vào dự án
         */
        cardOrderIds: ['card-id-111column-id-04-placeholder-card'],
        cards: [
          {
            _id: 'card-id-111column-id-04-placeholder-card',
            boardId: 'board-id-01',
